...
func GetDependencies(ctx context.Context, workspace string, artifact *latestV1.KoArtifact) ([]string, error) {
	return list.Files(workspace, artifact.Dependencies.Paths, artifact.Dependencies.Ignore)
}
